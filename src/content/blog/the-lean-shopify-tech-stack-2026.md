...
**Free replacement:** [Systeme.io — free for 2,000 contacts](/go/systeme/?source=the-lean-shopify-tech-stack-2026-n1) — 2,000 contacts, unlimited email sends, full automation sequences, sales funnels, and CRM. Permanently free, no credit card required.
...
**For larger lists:** [GetResponse — engagement-based billing](/go/getresponse/?source=the-lean-shopify-tech-stack-2026-n2) at $19/month covers 1,000 contacts with equivalent automation — still 80–90% cheaper than Klaviyo at equivalent list sizes.
...
The Complete Kit is the lean stack in file form — four Make.com JSON blueprints covering tracking (CAPI Shield + Google Ads), inventory (Stocky Swap), and P&L (P&L Auto), plus two pre-configured Google Sheets templates. $19.99 one-time, 10 minutes to deploy.
