...
Everything in this guide runs on free tools. The architecture above — Make.com writing to Sheets, Apps Script handling lightweight analysis — costs nothing for most stores: [create a free Make.com account — 1,000 ops/month at $0](/go/make/) (1,000 credits/month free) and build the hybrid pattern yourself in an afternoon.
