...
If your store uses multiple locations and has been recording transfers in Stocky, export this while the read-only window is open. If you use single-location inventory, transfers may be empty.
