...
Bing indexes the site normally. Same HTML, same robots.txt, same canonicals.
**That rules out a technical cause.** What remains is a site-level trust
assessment following the 10–11 Apr migration that ran without redirects until
23 Jul, on a domain that was DR 0 until recently (DR 4.1 / DA 6 as of 17 Aug).
